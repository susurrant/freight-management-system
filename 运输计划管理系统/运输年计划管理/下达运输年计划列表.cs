...
namespace 运输计划管理系统
{
    public partial class 下达运输年计划列表 : Form
    {
        private string cmp;
        private string year;
        ...
        public 下达运输年计划列表(string usrKind)
        {
        ...
        private void 下达运输年计划列表_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            { 
                ...
                下达调度令 dlg = new 下达调度令(this.dataGridView1.Rows[e.RowIndex].Cells["ID"].Value.ToString(), "年");
                dlg.ShowDialog(); 
            }

            if (e.ColumnIndex == 9)
            {
                运输月计划录入 dlg = new 运输月计划录入(this.dataGridView1.Rows[e.RowIndex].Cells["ID"].Value.ToString(), "下达");
                dlg.ShowDialog();
            }  
        }
        ...
        private void btn_schedule_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.dataGridView1.Rows.Count; i++)
            {
                if (this.dataGridView1.Rows[i].Cells[0].EditedFormattedValue.ToString() == "True")
                {
                    ...
                    {
                        MessageBox.Show("该年计划尚未下达调度令！", "提示");
                    }
                }
            }
        }
