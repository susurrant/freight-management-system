...
namespace 运输计划管理系统
{
    public partial class 已下达运输月计划列表 : Form
    {
        public 已下达运输月计划列表()
        {
            InitializeComponent();
        ...
        private void 已下达运输月计划列表_Load(object sender, EventArgs e)
        {
            ...
            String qStr = "select * from MonthPlanning where status = '已下达'";
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            string month = this.cb_month.Text;

            string sj = year + month;
            String qStr = "select company,date,amount,type,ID from MonthPlanning where company " + (cmp != "" ? ("= '" + cmp + "'") : "is not null") +
